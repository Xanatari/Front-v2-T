...
import { Button, Row, Card, Container,Stack, Image, Col } from 'react-bootstrap'
      ...
      <div className="row h-100">
        ...
        <Row className="h-100">
          ...
          <div className="caja-botones">
            <h3 className="text-primary" >Estudiante de Ingenieria de Sitemas</h3>
            <h3 className="text-primary">Habilidades a Evaluar</h3>
            <Button variant="light">Java</Button>{' '}
            <Button variant="light">SQL</Button>{' '}
            <Button variant="light">AWS</Button>{' '}
            <Button variant="light">Algoritmia</Button>{' '}
          </div>
          <div className="caja-generar-portafolio">
            <h1 className="text-info">Generar Portafolio Estudiante</h1>
            <div>
        ...
        <Stack>
          <Container className="mb-4">
              ...
              <h2 className="text-primary">Tecnologias a Evaluar</h2>
              <button className="btn btn-primary">Acción 1</button>{' '}
              <button className="btn btn-secondary">Acción 2</button>
      
          </Container>
         <Container className="mt-5">
              <h2 className="text-info">Convinacion de lo quieres evaluar </h2>
              <button className="btn btn-info">Botón 1</button>
              <button className="btn btn-info">Botón 2</button>
         </Container>
          <Container className="mt-5">
          <h2 className="text-danger">Resultados de tus evalacuiones</h2>
                <div className="p-2">FCalificacion 1</div>
                <div className="p-2">Calificaicon 2</div>
                <div className="p-2">Calificacion 3</div>
          </Container>
        </Stack>
        </div>
      </div>
